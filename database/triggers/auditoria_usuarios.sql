...
BEGIN
  ...
  VALUES (_id_auditoria, 'usuarios', NEW.dni, CURRENT_USER(), 'crear', NOW());
END //
DELIMITER ;
...
BEGIN
  ...
  SELECT MAX(id_auditoria) INTO max_id_auditoria FROM auditoria;
	...
	END IF;
  INSERT INTO auditoria (id_auditoria, tabla_afectada, reg_afectado, gestor, gestion, fecha_creacion) 
  VALUES (_id_auditoria, 'usuarios', OLD.dni, user(), 'eliminar', NOW());
END //
DELIMITER ;
...
BEGIN
  ...
  SELECT MAX(id_auditoria) INTO max_id_auditoria FROM auditoria;
	...
	END IF;
  INSERT INTO auditoria (id_auditoria, tabla_afectada, reg_afectado, gestor, gestion, fecha_creacion) 
  VALUES (_id_auditoria, 'usuarios', OLD.dni, user(), 'modificar', NOW());
END //
DELIMITER ;