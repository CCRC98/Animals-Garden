...
//  Admin homepage
router.get('/', adminController.homePageRender);
...
//  Vet list
router.get('/vetList', vetController.getVets);


//  Create vet
router.get('/createVet', vetController.createVetRender);

router.post('/createVet', vetController.createVet);


//  Update vet
router.get('/vetList/updateVet/:dni', vetController.updateVetByDniRender);

router.post('/vetList/updateVet/:dni', vetController.updateVetByDni);


//  Delete vet
router.get('/vetList/deleteVet/:dni', vetController.deleteVetByDni);


//  Vet profile
router.get('/vetList/vetProfile/:dni', vetController.getVetsData);
...
//  Create service
router.get('/servicesList/createService', serviceController.createServiceRender);
